...
public class Home extends AppCompatActivity {
    ...
    void startHotGame(){
        ...
        viewModel.gameType = GAME_TYPE.INSTANCE.getHOT();
    ...
    void startClassicGame(){
        viewModel.gameType = GAME_TYPE.INSTANCE.getCLASSIC();
        nextClassicQuestion();
        OpenGame();
    ...
    void onLaughMood() {
        MoodLog newLaughMood = new MoodLog(new Date(), MOOD.INSTANCE.getLAUGH());
    ...
    void onHappyMood() {
        ...
        MoodLog newHappyMood = new MoodLog(new Date(), MOOD.INSTANCE.getHAPPY());
    ...
    void onSadMood() {
        ...
        MoodLog newSadMood = new MoodLog(new Date(), MOOD.INSTANCE.getSAD());
    ...
    void onAngryMood() {
        ...
        MoodLog newAngryMood = new MoodLog(new Date(), MOOD.INSTANCE.getANGRY());
    ...
    void setUpQuestion(Question question) {
        ...
        tvTopic.setText(TOPIC.INSTANCE.getTopic(question.getTopic()));
